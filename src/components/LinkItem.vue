...
<script lang="ts">
    ...
    export default class LinkItem extends Vue {
        ...
        public timeDifferenceForDate = timeDifferenceForDate;
        public linksPerPage: string = LINKS_PER_PAGE;

        public get userId(): number {
            return this.$root.$data.userId;
        }
        public get linkNumber(): number {
        ...
        public updateStoreAfterVote(store, createVote, linkId): void {
            // 1
